...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20230919185806_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Campsite", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CampsiteTypeId = 1,
                            ImageUrl = "https://hips.hearstapps.com/hmg-prod/images/pmx070118summercamping-005-1529681336.jpg?resize=1200:*",
                            Nickname = "Tentrr"
                        },
                        new
                        {
                            Id = 3,
                            CampsiteTypeId = 2,
                            ImageUrl = "https://camperreport.com/wp-content/uploads/2021/03/MinutemanCG-1024x576.jpg",
                            Nickname = "Cozy Acre"
                        },
                        new
                        {
                            Id = 4,
                            CampsiteTypeId = 3,
                            ImageUrl = "https://i.pinimg.com/564x/9f/67/53/9f67535d9b23437e36c83e8827ea4fda.jpg",
                            Nickname = "Bush Style"
                        },
                        new
                        {
                            Id = 5,
                            CampsiteTypeId = 4,
                            ImageUrl = "https://blog-assets.thedyrt.com/uploads/2019/07/hammock-camper-view.jpg",
                            Nickname = "Mountain Side"
                        },
                        new
                        {
                            Id = 6,
                            CampsiteTypeId = 4,
                            ImageUrl = "https://content.artofmanliness.com/uploads/2016/07/hammock.jpg",
                            Nickname = "River Run"
                        });
                });
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CampsiteId = 1,
                            CheckinDate = new DateTime(2023, 9, 28, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CheckoutDate = new DateTime(2023, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserProfileId = 1
                        });
                });
            ...
            modelBuilder.Entity("CreekRiver.Models.UserProfile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Email = "trenton.guffey@gmail.com",
                            FirstName = "Trenton",
                            LastName = "Guffey"
                        });
                });
